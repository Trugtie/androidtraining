...
import vn.edu.stu.quanlycongviec.util.FormatUtil;
...
public class ThemSua extends AppCompatActivity {
    ...
    private void addControls(){
        ...
        btnDatePicker = findViewById(R.id.btnNgay);
        btnTimePicker = findViewById(R.id.btnGio);
    ...
    private void xuLyChonNgay(){
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(ThemSua.this, listener,
    ...
    private void xuLyChonGio(){
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(ThemSua.this,listener,
